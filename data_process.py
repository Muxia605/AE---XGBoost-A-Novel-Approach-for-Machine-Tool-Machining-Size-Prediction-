...
def train(regressor, strategy, X, y, c, dataset_name,fold):
  ...
  train_output_file = f"train_SG_{dataset_name}.csv"
  ...
  for strategy in strategys:
      ...
      for regressor_name, regressor in regressors.items():
        ...
        for fold, (train_index, test_index) in enumerate(outer.split(X, y)):
            ...
            pd.DataFrame(pred).to_csv(r'E:\Program Files (x86)\python\python-project\XGboost\result612\Pred{}_{}_{}.csv'.format(fold, strategy, model_name, index = False))
dataset_path = 'train_r_231102a.csv'
